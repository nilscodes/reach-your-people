...
internal class SnapshotServiceVibrantTest {
    ...
    private val service = SnapshotServiceVibrant(tokenDao, stakepoolDao, redisTemplate, rabbitTemplate)
    ...
    fun `snapshot information gets pushed to redis from both policies and stake pools if present`() {
        ...
        every { stakepoolDao.getActiveDelegationWithoutAmount(any()) } returns listOf(
            DelegationInfoDto("poolHash", 1, "stakeAddress2")
        )
        ...
        service.processSnapshot(SnapshotRequestDto(AnnouncementJobDto(12, announcementUuid, null), listOf("4523c5e21d409b81c95b45b0aea275b8ea1406e6cafea5583b9f8a5f"), listOf("poolHash")))
